...
/// <summary>Encodes and validates CloudEvents 1.0 structured JSON payloads.</summary>
public sealed class JsonCloudEventCodec(JsonSerializerOptions? options = null) : ICloudEventCodec
{
    /// <summary>Gets the MQTT 5 content type for structured CloudEvents JSON.</summary>
